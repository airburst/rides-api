...
describe("RRule Utilities", () => {
  describe("makeRidesInPeriod", () => {
    ...
    test("respects RRule UNTIL date", () => {
      const template = createTemplate({
        schedule: "FREQ=WEEKLY;BYDAY=SA;UNTIL=20260315T090000;DTSTART=20260301T090000",
      });
  ...
  describe("updateRRuleStartDate", () => {
    ...
    test("preserves other RRule parameters", () => {
      const schedule = "FREQ=WEEKLY;BYDAY=MO,WE,FR;INTERVAL=1;DTSTART=20260101T090000";
    ...
    test("preserves UNTIL parameter", () => {
      const schedule = "FREQ=WEEKLY;BYDAY=SA;UNTIL=20261231T090000;DTSTART=20260101T090000";
